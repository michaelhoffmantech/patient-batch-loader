...
import com.pluralsight.springbatch.patientbatchloader.service.AuditEventService;
...
public class AuditResource {
	...
	public ResponseEntity<AuditEvent> get(@PathVariable Long id) {
		return auditEventService.find(id).map(response -> ResponseEntity.ok().headers(null).body(response))
